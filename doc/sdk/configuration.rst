...
The ActiveTrust Dossier and TIDE Lookup Service application requires a set of configuration files to operate.
...
ActiveTrust Dossier and TIDE Lookup Service (activetrustlookup.config)
----------------------------------------------------------------------

    The required ``activetrustlookup.config`` file is used to configure the application.
